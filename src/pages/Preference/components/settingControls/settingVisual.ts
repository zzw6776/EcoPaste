...
const SETTING_ICON_MAP: Record<string, string> = {
  ...
  "androidGesture.enabled": "i-lucide:hand",
  "androidGesture.hideOverlay": "i-lucide:eye-off",
  "androidGesture.leftHeightDp": "i-lucide:move-vertical",
  "androidGesture.leftWidthDp": "i-lucide:move-horizontal",
  "androidGesture.popupHeightPercent": "i-lucide:panel-bottom",
  "androidGesture.rightHeightDp": "i-lucide:move-vertical",
  "androidGesture.rightWidthDp": "i-lucide:move-horizontal",
  ...
  "sync.autoUploadMaxMb": "i-lucide:file-up",
  "sync.autoWriteClipboard": "i-lucide:clipboard-check",
  "sync.devices": "i-lucide:monitor-smartphone",
  "sync.enabled": "i-lucide:refresh-cw",
  "sync.serverDirectAddresses": "i-lucide:network",
  "sync.serverEndpointId": "i-lucide:server",
  "sync.serverRelayUrls": "i-lucide:cloud",
  "sync.syncSensitive": "i-lucide:shield-alert",
