...
export const PREVIEW_PANEL_MIN_WIDTH = 460;
export const PREVIEW_PANEL_MAX_HEIGHT = 600;
export const PREVIEW_PANEL_MAX_WIDTH = 680;
export const PREVIEW_PANEL_HEADER_HEIGHT = 40;
...
export const PREVIEW_TEXT_ROW_HEIGHT = 28;
